...
file_name = '/home/nhamnx28/ocr/ocr_receipt/test_folder/my_project/bhx_test.jpg'
...
class DocScanner(object):
    ...
    def scan(self, image, output_path=None, binary=False):
        ...
        warped_process = cv2.adaptiveThreshold(sharpen, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 21, 15)
